...
# docker build --rm -t registry-vpc.cn-shanghai.aliyuncs.com/russellcloud/caffe:2.0-py2.7 -f Dockerfile-py2 .
...
# GPU test
cd caffe2 && python caffe2/python/operator_test/relu_op_test.py
